...
local function CreateMainGUI()
    ...
    ScreenGui.Name = "KemilingHUB | GAG"
    ...
    local function GetUserStatus()
        local success, whitelist = pcall(function()
            local response = game:HttpGet("https://raw.githubusercontent.com/KemilingHUB/growagarden/refs/heads/main/growagardenlist.lua", true)
    ...
    BasicButton.Text = "Grow A Garden Script"
    ...
    BasicButton.MouseButton1Click:Connect(function()
        ...
        if userStatus.needsPurchase then
            ...
            WarningText.Font = Enum.Font.GothamBold
            WarningText.Text = "Under Maintance"
            ...
            PurchaseText.Text = "You Dont Have Permission To Accses This Script"
